...
PASS_MYSQL_ROOT="Password1" # this you need to save 
PASS_PHPMYADMIN_APP="Password1" # can be random, won't be used again
...
# NOTE: Skipped validate_password because it causes issues with the password in this script
}
...
echo -e "\n${Green} SUCCESS! PHPMyAdmin password is: ${PASS_PHPMYADMIN_APP} ${Color_Off}"
echo -e "\n${Green} NOTE: MYSQL password will not be overwritten if already set ${Color_Off}"
